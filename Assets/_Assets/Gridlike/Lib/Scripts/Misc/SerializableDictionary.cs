...
namespace Gridlike {
	...
	/// <summary>
	/// A Unity-serializable dictionary implementation
	/// </summary>
	...
	public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		public void Clear()
		{
			...
			System.Array.Clear(_Keys, 0, _Count);
			System.Array.Clear(_Values, 0, _Count);
			System.Array.Clear(_HashCodes, 0, _Count);
			System.Array.Clear(_Next, 0, _Count);
		...
		private void Resize(int newSize, bool forceNewHashCodes)
		{
			...
			System.Array.Copy(_Values, 0, valuesCopy, 0, _Count);
			System.Array.Copy(_Keys, 0, keysCopy, 0, _Count);
			System.Array.Copy(_HashCodes, 0, hashCodesCopy, 0, _Count);
			System.Array.Copy(_Next, 0, nextCopy, 0, _Count);
